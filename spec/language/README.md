...
The authoritative grammar is `tools/language/Cascode.g4`. The standard library under `lib/std/**`
and the golden fixtures under `tests/golden/cas/**` are the canonical examples of current syntax and
intended behavior.
...
- Chapter 1 (`Ch01_Introduction.md`) gives the language and toolchain overview.
- Chapter 2 (`Ch02_Core_Concepts.md`) defines the semantic model: terminals, connectivity, benches,
