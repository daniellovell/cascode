...
bench SpBench {
  ...
  analysis {
    SPAnalysis sp = new SPAnalysis(space=Log, samples=10, start=1Hz, stop=1kHz, noise=(1 + 1))
  }
...
bench SpBench {
  ...
  analysis {
    SPAnalysis sp = new SPAnalysis(space=Log, samples=10, start=1Hz, stop=1kHz, noise=1Hz)
  }
...
""";
        ...
        Assert.Contains(
            ...
            d =>
                ...
                && d.Message.Contains("expects 'Scalar'", StringComparison.Ordinal)
        );
    }
