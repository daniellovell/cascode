...
/// <summary>
/// Intermediate structural view of a motif used before lowering to ACIR.
/// </summary>
...
internal sealed class NetInfo
{
    ...
    /// <summary>Domain name used for ACIR lowering. Valid values: <c>signal</c> (default), <c>analog</c>, <c>digital</c>, <c>mixed</c>, <c>supply</c>, <c>ground</c>, <c>bias</c>, <c>rf</c>, <c>clock</c>.</summary>
