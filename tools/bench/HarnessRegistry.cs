...
{
    private readonly Dictionary<string, ITestbenchHarness> _harnesses = new(StringComparer.OrdinalIgnoreCase);
    ...
    public bool TryGet(string id, out ITestbenchHarness harness) => _harnesses.TryGetValue(id, out harness!);
