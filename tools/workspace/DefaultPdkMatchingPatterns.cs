    ...
    public static PdkMatchingConfig Build()
    {
        var cfg = new PdkMatchingConfig
        {
            ...
            Classify = new PdkMatchingConfig.ClassifySection
            {
                ...
                {
                    ["stdcell"] = new PdkMatchingConfig.ClassPattern
                    {
                        Prefixes = new()
                        {
                            "inv",
                    ...
                    ["nmos"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "nmos", "nfet", "nch" },
                        Regex = new() { "_nch", "_n_" },
                    },
                    ["pmos"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "pmos", "pfet", "pch" },
                        Regex = new() { "_pch", "_p_" },
                    },
                    ["bipolar"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "npn", "pnp" },
                    },
                    ["diode"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "diode" },
                        Prefixes = new() { "d" },
                    },
                    ["resistor"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "res", "tfr", "rmetal", "rpoly", "rwell" },
                        Prefixes = new() { "r" },
                    },
                    ["capacitor"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "cap", "moscap", "nmoscap", "pmoscap" },
                        Prefixes = new() { "c" },
                    },
                    ["inductor"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "ind" },
                        Prefixes = new() { "l" },
                    },
                    ["transmissionline"] = new PdkMatchingConfig.ClassPattern
                    {
                        Contains = new() { "tline" },
                    },
                },
                ...
                {
                    ["stdcell"] = new System.Collections.Generic.Dictionary<
                        string,
                        PdkMatchingConfig.ClassPattern
                    ...
                    ["capacitor"] = new System.Collections.Generic.Dictionary<
                        string,
                        PdkMatchingConfig.ClassPattern
                    >(System.StringComparer.OrdinalIgnoreCase)
                    {
                    ...
                    ["nmos"] = new System.Collections.Generic.Dictionary<
                        string,
                        PdkMatchingConfig.ClassPattern
                    >(System.StringComparer.OrdinalIgnoreCase)
                    {
                    ...
                    ["pmos"] = new System.Collections.Generic.Dictionary<
                        string,
                        PdkMatchingConfig.ClassPattern
                    >(System.StringComparer.OrdinalIgnoreCase)
                    {
    ...
    public static string RenderYaml(PdkMatchingConfig cfg)
    {
        var serializer = new YamlDotNet.Serialization.SerializerBuilder()
            ...
            .ConfigureDefaultValuesHandling(
                YamlDotNet.Serialization.DefaultValuesHandling.OmitDefaults
            )
            .Build();
