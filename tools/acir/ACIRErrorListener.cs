...
/// </summary>
internal sealed class ACIRErrorListener : IAntlrErrorListener<IToken>, IAntlrErrorListener<int>
{
    ...
    public ACIRErrorListener(string filePath, List<Diagnostic> diagnostics)
    {
        _filePath = filePath;
