...
/// <summary>
/// Adapter that converts Cascode circuits and bench definitions to TestbenchContext.
/// </summary>
public static class CascodeBenchAdapter
{
    /// <summary>
    ...
    /// <summary>
    /// Converts an Cascode circuit and bench definition to a TestbenchContext.
    /// </summary>
    /// <param name="circuit">Cascode circuit.</param>
    ...
    /// <param name="document">Optional Cascode document for checking subcircuit models.</param>
    ...
    /// </summary>
    internal static bool UsesGenericModels(Circuit circuit, CascodeDocument? document = null)
    {
    ...
    )
    {
        ...
        var harness = new CascodeTemplateHarness();
