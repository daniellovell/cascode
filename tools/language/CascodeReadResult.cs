...
/// <summary>
/// Result of reading an Cascode document, containing the parsed document and any diagnostics.
/// </summary>
/// <remarks>
...
/// <see cref="Cascode.Parser"/> with Cascode-specific error codes.
/// </remarks>
public sealed class CascodeReadResult
{
    /// <summary>
    /// Parsed Cascode document when reading succeeds; <c>null</c> if any fatal diagnostics were emitted.
    /// </summary>
    public CascodeDocument? Document { get; init; }
