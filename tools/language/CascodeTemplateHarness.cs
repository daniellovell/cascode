...
/// <summary>
/// Harness for Cascode-based testbenches that uses embedded templates.
/// </summary>
public sealed class CascodeTemplateHarness : ITestbenchHarness
{
    public string Id => "acir_template";
    public string Description => "Cascode template-based testbench harness";
