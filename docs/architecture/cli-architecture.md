...
- PDK emit: `pdk emit primitives [--pdk <name>] [--out <file.cas>] [--include-fixed]`. Default output is canonical parametric primitive families; `--include-fixed` includes fixed wrapper variants.
